...
(function() {
  var GObject, Line, Point, Polygon, Rectangle, Shape, TextElement,
  ...
  TextElement = (function(_super) {

    __extends(TextElement, _super);

    function TextElement(x, y, text) {
      this.text = text;
      TextElement.__super__.constructor.call(this, x, y);
      this.color = "#000000";
      this.font = "italic bold 30px sans-serif";
    ...
    TextElement.prototype.draw = function(context) {
      ...
      if (this.fill) {
        ...
        return context.strokeText(this.text, this.x, this.y);
      }
    };
